var sql = {
	...
	SELECT : "SELECT id, observer_name, observer_tel, observer_email, observation_datetime, observation_location, observation_localisation, observation_region, observation_country, observation_latitude, observation_longitude, observation_number, observation_culled, counting_method_timed_swim, counting_method_distance_swim, counting_method_other, depth_range, observation_method, remarks, admin_validation, status FROM cotfj_admin where id = (?);",
	SELECTexistLIST : "SELECT * FROM cotfj_admin;",
	SELECTidINSERT : "SELECT id FROM cotfj_admin where observer_name=(?) and observer_tel=(?) and observer_email=(?) and observation_datetime=(?) and observation_location=(?) and observation_localisation=(?) and observation_region=(?) and observation_country=(?) and observation_latitude=(?) and observation_longitude=(?) and observation_number=(?) and observation_culled=(?) and counting_method_timed_swim=(?) and counting_method_distance_swim=(?) and counting_method_other=(?) and depth_range=(?) and observation_method=(?) and remarks=(?) and date_enregistrement=(?);",
	SELECTCOTLIST : "SELECT id, observation_datetime, observation_location, observation_localisation, observation_number, date_enregistrement FROM cotfj_admin where status<>'synchronized';",
